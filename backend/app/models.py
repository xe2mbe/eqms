...
class LibretaConfigUsuario(Base):
    ...
    asl_boletin_node = Column(String(20), nullable=True)
    irlp_reflector_id = Column(String(20), nullable=True)
    irlp_ref_url = Column(String(500), nullable=True)
    irlp_user = Column(String(80), nullable=True)
    irlp_password = Column(String(200), nullable=True)
    ...
    bm_api_key = Column(Text, nullable=True)
    updated_at = Column(DateTime(timezone=True), onupdate=func.now())
