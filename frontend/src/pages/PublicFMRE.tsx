...
import {
  ...
  RadarChartOutlined, SearchOutlined, UserOutlined,
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', system-ui, sans-serif", background: '#f5f7fa', minHeight: '100vh' }}>
      ...
      {stats?.ultimo_evento_rf && (
        <UltimoEventoBanner variant="rf" evento={stats.ultimo_evento_rf} onClick={handleUltimoEvento} />
      )}

      {/* ── ÚLTIMO EVENTO RS ── */}
      {stats?.ultimo_evento_rs && (
        <UltimoEventoBanner variant="rs" evento={stats.ultimo_evento_rs} onClick={handleUltimoEventoRS} />
      )}
